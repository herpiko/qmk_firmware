...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_uhk(
    ...
    KC_ESC,    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,            KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,    KC_EQL,    KC_BSPACE, KC_NO, 
    KC_HOME,   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_NO,           KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,       KC_LBRC,   KC_RBRC,   KC_BSLASH,
    KC_END,    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_NO,           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,    KC_QUOT,   KC_ENT,    KC_NO,
    KC_INSERT, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_NO,           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_LSFT,   KC_PGUP,   KC_NO,
    KC_DELETE, KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  KC_NO,   KC_NO,           KC_SPC,  KC_RGUI, KC_RALT, KC_RCTL, KC_PSCREEN, KC_PGDOWN, KC_NO,     KC_NO
  ),
