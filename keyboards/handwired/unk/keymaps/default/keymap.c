...
int layoutMode = 0; // 0 = QWERTY, 1 = COLEMAK, 2 = GAME
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT(
    ...
    KC_END,          KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,      KC_G,                           KC_H,    KC_J,      KC_K,    KC_L,    KC_SCLN,    KC_QUOT,    KC_ENT,
    KC_PRINT_SCREEN, KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,      KC_B,                           KC_N,    KC_M,      KC_COMM, KC_DOT,  KC_SLSH,    KC_LSFT,    KC_PAGE_UP,
    KC_F3,           KC_LCTL,   KC_LALT, KC_LGUI, LOWER,   KC_SPACE,                                           KC_SPACE,  RAISE,   KC_RALT, KC_RCTL,    KC_DELETE,  KC_PAGE_DOWN
  ),

  [_LOWER] = LAYOUT(
    GAME, _______,      KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,                      KC_F7,       KC_F8,      KC_F9,         KC_F10,       KC_F11,     KC_F12,  KC_F3,
    ...
    GAME, _______,      _______, _______, _______,  _______, _______,                             _______,     KC_PAGE_UP, _______,       KC_PAGE_DOWN, _______,    _______, KC_VOLU,
