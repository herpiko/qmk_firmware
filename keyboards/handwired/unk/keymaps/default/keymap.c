...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    QWERTY,  _______, _______, _______, _______,  _______, _______,                    _______, _______,    KC_MS_UP,   _______,    _______,     _______,    _______, _______,
    COLEMAK, _______, _______, _______, _______,  _______, _______,                             KC_MS_BTN1, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_BTN2, _______, _______,
    _______, KC_MS_ACCEL2, _______, _______, _______,  _______, _______,                        _______,    KC_PGUP,    _______,    KC_PGDOWN,   _______,    _______, KC__VOLUP, 
